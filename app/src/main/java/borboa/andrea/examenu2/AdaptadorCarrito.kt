...
class AdaptadorCarrito internal constructor(private val productosList: List<item>) :
    ...
    override fun onBindViewHolder(holder: CarritoViewHolder, position: Int) {
        ...
        holder.total.setText("${productosList[position].total}")
        var totalNuevo:Double=0.0
        ...
        holder.btn_mas.setOnClickListener {
            ...
            holder.total.setText("${totalNuevo}")
        }
